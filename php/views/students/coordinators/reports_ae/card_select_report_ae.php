...
if (isset($_GET['id_academic_area']) && isset($_GET['id_academic_level']) && isset($_GET['id_subject'])) {
    ...
    if ($grants & 8) {
        ...
        $getSubjects = $expected_learnings->getSubjectsLGTeacher($id_academic_area, $id_academic_level, $no_teacher);
    }
}
...
if (isset($_GET['id_academic_level'])) {
    ...
    if ($grants & 8) {
        ...
        $getAcademicLevel = $expected_learnings->getAcademicLevelTeacher($id_academic_area, $no_teacher);
    }
}
?>
...
if (isset($_GET['id_academic_area']) && isset($_GET['id_academic_level'])) {
    ...
    if ($grants & 8) {
        include_once 'show_reports_ae.php';
    } else if ($grants & 4) {
        include_once 'show_reports_ae_teacher.php';
    }
}
?>