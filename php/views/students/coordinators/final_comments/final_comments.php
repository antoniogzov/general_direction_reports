...
$lmps_fc = array();
$lmps_fc = $cualitatives->getLearningMapsCoordinatorHebPrim($no_teacher);

$installment = 5;

include 'card_select_final_comments.php';
...
<script src="js/functions/evaluations_cualitatives/getFinalComments.js"></script>
<script src="js/functions/evaluations_cualitatives/downloadFinalComments.js"></script>
