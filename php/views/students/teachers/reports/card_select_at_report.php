...
if ($submodule == "attendance_report") {
    if (($grants & 8)) {
        ...
        (SELECT sbj.name_subject, sbj.id_subject, assg.id_assignment,  groups.id_group, groups.group_code, assg.print_school_report_card, assg.assignment_active, rel_coord_aca.no_teacher, groups.group_type_id
        ...
        SELECT  sbj.name_subject, sbj.id_subject, asgm.id_assignment, gps.id_group, gps.group_code, asgm.print_school_report_card, asgm.assignment_active, rel_coord_aca.no_teacher, gps.group_type_id
        FROM iteach_academic.relationship_coordinators_academic_areas AS rel_coord_aca
        ...
        SELECT  sbj.name_subject, sbj.id_subject, asg.id_assignment, groups.id_group, groups.group_code, asg.print_school_report_card, asg.assignment_active, asg.no_teacher, groups.group_type_id
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="form-control-label" for="att_type">* Filtrar tipo de asistencia</label>
                        <form>
                            <?php if (!isset($_GET['att_type'])) : ?>
                                ...
                                <?php else : ?>
                                    ...
                                    <?php endif; ?>
                                    <option selected value="" disabled>Elija una opción</option>
                                    <option value="1">Excluir Faltas Justificadas</option>
