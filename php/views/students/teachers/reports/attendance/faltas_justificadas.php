    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12 container-list-students">
                ...
                <h2 class="heading mb-0 ml-2">FALTAS JUSTIFICADAS del <?= ($arr_week[1]) ?> de <?= $months[$arr_week[0]] ?> de <?= $arr_week[2] ?> AL <?= ($arr_week2[1]) ?> de <?= $months[$arr_week2[0]] ?> de <?= $arr_week2[2] ?></h2>
                <?php
