...
include 'php/models/academic_reports.php';
$academicReports  = new AcademicReports;
...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="example-number-input" class="form-control-label">% Mínimo</label>
                    <?php if (isset($_GET['min'])) : ?>
                        <input class="form-control" type="number" value="<?= $_GET['min'] ?>" min="1" max="10" id="min">
                    <?php else : ?>
                        <input class="form-control" type="number" value="0" min="0" max="100" id="min">
                    <?php endif; ?>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="example-number-input" class="form-control-label">% Máximo</label>
                    <?php if (isset($_GET['max'])) : ?>
                        <input class="form-control" type="number" value="<?= $_GET['max'] ?>" min="1" max="10" id="max">
                    <?php else : ?>
                        <input class="form-control" type="number" value="50" min="0" max="100" id="max">
                    <?php endif; ?>
                </div>
            </div>
            <div class="col-md-3">
