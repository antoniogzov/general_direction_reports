<?php
$getSubjects = $subjects->getSubjectsGroupsFromManagerByAcademicArea($no_teacher, $id_academic_area);
?>
			...
			<div class="col">
				<div class="card col-md-12">
					...
					<div class="table-responsive">
						<table class="table align-items-center table-dark table-borderedtable-flush text-center" id="tableSubjectsCoordinator" style="table-layout: fixed;">
							<thead class="thead-dark">
								<tr>
									...
									<th scope="col" class="font-weight-bold">Profesor</th>
							...
							<tbody class="list">
									...
									<tr>
										...
										<td scope="row" class="text-center">
											<div class="avatar-group">
												...
												<a href="aprendizajes_esperados.php?id_assignment=<?= $row->id_assignment ?>" style="background-color:#0059d5 !important;" class="avatar avatar-sm rounded-circle hover" data-toggle="tooltip" data-original-title="AE">
								...
								<?php endforeach;
								include 'php/views/index/modal_export_config_coordinator.php';
								?>
							</tbody>
						</table>
					</div>
