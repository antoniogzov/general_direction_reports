...
if (isset($_GET['id_academic_area']) && isset($_GET['id_academic_level']) && isset($_GET['id_subject']) && isset($_GET['id_period']) && isset($_GET['id_level_grade'])) {
    ...
    $getGroupsSubject = $qualifications_reports->getGroupsBySubject($no_teacher, $id_subject, $id_level_grade);
}
...
if (isset($_GET['id_academic_level'])) {
    ...
    $getSubjects = $expected_learnings->getSubjectsLG2($id_academic_area, $id_level_grade, $no_teacher);
}
?>
...
<?php
if (isset($_GET['id_academic_area']) && isset($_GET['id_subject']) && isset($_GET['id_subject']) && isset($_GET['id_period']) && isset($_GET['id_level_grade'])) {
    ?>
    <script>
        Swal.fire({
            text: "Cargando...",
...
<?php
    include_once 'show_subjects_qualifications.php';
