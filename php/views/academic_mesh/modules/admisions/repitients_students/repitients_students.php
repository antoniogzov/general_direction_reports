...
include 'card_select_repitients_students.php';
?>

<?php if ($grants & 8) :
    if (isset($_GET['id_academic'])) {

        $students = $admisions->getRepitientsStudents($_GET['id_academic']);
?>
                    ...
                    <div class="card col-md-12">
                        <?php if (!empty($students)) : ?>
                            <div class="card-header border-0">
                                <h3 id="title_horario">ALUMNOS REPITIENTES DEL CICLO ESCOLAR <?= $students[0]->school_year ?></h3>
                                <h5 id="title_horario">TOTAL DE ALUMNOS <?= count($students) ?></h5>
                            </div>
